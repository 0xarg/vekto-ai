...
const raw: Agent[] = [
  ...
  },
  {
    ...
    step: 2,
    name: "Analysis",
    role: "Classifies each artifact by complexity and migration approach.",
    description:
      "Analysis reads the inventory and classifies every artifact: what maps cleanly onto the target platform, what needs restructuring, and what has no direct equivalent and will require a human decision. This is the stage that produces the honest scope of the migration rather than an estimate.",
    inputs: ["Artifact inventory from Discovery", "Target platform selection"],
    outputs: [
      "Per-artifact complexity classification",
  ...
  },
  {
    ...
    description:
      "Transformation converts classified artifacts into working implementations on the target platform, following the mapping strategy produced by Analysis. Output is source code and configuration in the target platform's own formats, intended to be reviewed, versioned and owned by your team.",
    inputs: [
  ...
  },
  {
    ...
    step: 4,
    name: "Validation",
    role: "Checks generated implementations against the original behavior.",
    description:
      "Validation compares the generated implementation against the behavior of the source estate, checks it against the target platform's own rules, and surfaces the differences. Its purpose is to make the gap between old and new explicit rather than to declare the migration finished.",
    inputs: [
      "Generated implementations from Transformation",
      "Source behavior captured during Discovery",
    ],
    outputs: [
  ...
  },
  {
    ...
    description:
      "Reporting assembles the record of the migration: what was found, how each artifact was handled, what was changed by hand and what remains open. This is the artifact your architects review and your auditors ask for.",
    inputs: [
    ...
    outputs: [
      ...
      "Per-artifact disposition record",
